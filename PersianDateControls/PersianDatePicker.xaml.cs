...
namespace PersianLib.PersianDateControls
{
    ...
    public partial class PersianDatePicker : UserControl
    {
        ...
        {
            get { return (PersianLib.PersianDate)GetValue(SelectedDateProperty); }
        ...
        static PersianDatePicker()
        {
            ...
            SelectedDateProperty =
                DependencyProperty.Register("SelectedDate", typeof(PersianLib.PersianDate), typeof(PersianDatePicker), selectedDateMetadata);
